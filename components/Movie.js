...
function Movie(props) {
  ...
  //Description over 250 caractères
  let overviewFormatted = '';
  if (props.overview.length > 250){
   overviewFormatted = props.overview.substring(0, 250) + '...'
   
  } else {
    overviewFormatted = props.overview
  }
    ...
    <div className={styles.card}>
      ...
      <div className={styles.textContainer}>
        <div>
          ...
          <p className={styles.description}>{overviewFormatted}</p>
        </div>
